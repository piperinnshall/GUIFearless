...
class CFrameBuilder<R> implements FrameBuilder<R> {
  ...
  @Override public FrameBuilder<R> panel(PanelScope scope) { var pb = new CPanelBuilder(); scope.run(pb); pbs.add(pb); return this; }
...
record CMouseBuilder(CPanel panel) implements MouseBuilder {
  ...
  @Override public MouseBuilder clicked(Consumer<MouseCtx> action) { return mouse(new MouseAdapter() { public void mouseClicked(MouseEvent e) { action.accept(ctx(e)); } }); }
  @Override public MouseBuilder pressed(Consumer<MouseCtx> action) { return mouse(new MouseAdapter() { public void mousePressed(MouseEvent e) { action.accept(ctx(e)); } }); }
  @Override public MouseBuilder released(Consumer<MouseCtx> action) { return mouse(new MouseAdapter() { public void mouseReleased(MouseEvent e) { action.accept(ctx(e)); } }); }
  @Override public MouseBuilder moved(Consumer<MouseCtx> action) { return motion(new MouseMotionAdapter() { public void mouseMoved(MouseEvent e) { action.accept(ctx(e)); } }); }
  @Override public MouseBuilder dragged(Consumer<MouseCtx> action) { return motion(new MouseMotionAdapter() { public void mouseDragged(MouseEvent e) { action.accept(ctx(e)); } }); }
  @Override public MouseBuilder entered(Consumer<MouseCtx> action) { return mouse(new MouseAdapter() { public void mouseEntered(MouseEvent e) { action.accept(ctx(e)); } }); }
  @Override public MouseBuilder exited(Consumer<MouseCtx> action) { return mouse(new MouseAdapter() { public void mouseExited(MouseEvent e) { action.accept(ctx(e)); } }); } 
}
...
record CGraphicsCtx(Graphics2D g2d, long elapsed, Vec2 screenSize, Vec2 panelSize) implements GraphicsCtx {
  ...
  @Override public GraphicsCtx rect(Vec2 pos, Vec2 dim) { g2d.fillRect(r(pos.x()), r(pos.y()), r(dim.x()), r(dim.y())); return this; }
  @Override public GraphicsCtx oval(Vec2 pos, Vec2 dim) { g2d.fillOval(r(pos.x()), r(pos.y()), r(dim.x()), r(dim.y())); return this; }
  @Override public GraphicsCtx line(Vec2 from, Vec2 to) { g2d.drawLine(r(from.x()), r(from.y()), r(to.x()), r(to.y())); return this; }
  @Override public GraphicsCtx color(Vec3 rgb) { g2d.setColor(Awt.color(rgb)); return this; }
...
class CPanel extends JPanel {
  ...
  CPanel(GraphicsScope paintable, CFrame frame) { this.paintable = paintable; this.frame = frame; }
